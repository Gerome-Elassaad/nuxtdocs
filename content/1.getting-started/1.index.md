...
::card-group
  ...
  aria-label: Learn more about CodinIT on our website
  ---
  ...
  aria-label: Understand key development terms in our documentation
  ---
  ...
  aria-label: prompting with codinit
  ---
  ...
  aria-label: Stay updated with the latest from the CodinIT team
  ---
